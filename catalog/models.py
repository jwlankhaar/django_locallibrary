...
class Genre(models.Model):
    ...
    class Meta:
        permissions = ((
            'can_create_update_delete_genre',
            'Create, update or delete a genre'
        ),)
...
class Book(models.Model):
    ...
    # can have multiple books Author as a string rather than object because
    ...
    class Meta:
        permissions = ((
            'can_create_update_delete_book', 'Create, update or delete a book'
        ),)
...
class BookInstance(models.Model):
    ...
    class Meta:
        ...
        permissions = (('can_mark_returned', 'Set book as returned'),
                       ('can_create_update_delete_bookinstance',
                        'Create, update or delete a book copy'))
...
class Author(models.Model):
    ...
    class Meta:
        ...
        permissions = (('can_create_update_delete_author',
                        'Create, update or delete author details'),)
